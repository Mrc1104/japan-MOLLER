...
template<typename T>
using VQwDataHandlerFactory = class VQwFactory<VQwDataHandler<T>>;
...
template <class T, class subsystem_t>
class MQwDataHandlerCloneable: public MQwCloneable<VQwDataHandler<T>,subsystem_t> { };
